    ...
    <table>
        ...
        <tfoot>
            <tr>
                ...
                <td class="center bold">Total net</td>
                <td class="center bold">{{ $estimate->total }} €</td>
            </tr>
            <tr>
                <td class="center bold">Acompte début des travaux versé</td>
                <td colspan="2" class="center bold">{{ '-'.$estimate->advance }} €</td>
            </tr>
            @if ($estimate->big_construction)
            <tr>
                <td class="center bold">Acompte milieu des travaux versé</td>
                <td colspan="2" class="center bold">{{ '-'.$estimate->advance }} €</td>
                @php($estimate->advance += $estimate->advance)
            </tr>
            @endif
            <tr>
                <td class="center bold underline ft12">RESTANT DÛ</td>
                @php($estimate->total -= $estimate->advance )
                <td colspan="2" class="center bold underline ft12">{{ $estimate->total }} €</td>
            </tr>
        </tfoot>
    </table>
